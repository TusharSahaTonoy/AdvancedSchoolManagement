      ...
      <ul class="nav-right">
        ...
        @auth
          ...
          <ul class="dropdown-menu fsz-sm">
            ...
            <li>
              <a href="javascript:void(0);" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="ti-power-off mR-10"></i>
                <span>Logout</span>
              </a>
            </li>
        ...
        @else    
          <li><a id="sidebar-toggle" href="{{url('login')}}"><i class="text-info ti-anchor"></i>Login</a>
          </li>
        @endauth
